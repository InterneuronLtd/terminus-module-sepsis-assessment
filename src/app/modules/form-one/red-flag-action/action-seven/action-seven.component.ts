...
@Component({
  selector: 'app-action-seven',
  templateUrl: './action-seven.component.html',
  styleUrls: ['./action-seven.component.css']
})
export class ActionSevenComponent extends FormOneTaskBaseComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.taskSevenDataObj = super.retrieveAssessmentTask(this.actionMode,
      FORM_ONE_CONFIG.enabled_sepsis_task_id.sepsistask_7_id, this.assessment.assessmenttasks);

    this.originalTaskDataObj = this.taskSevendata = super.retrieveTaskData(this.actionMode, FORM_ONE_CONFIG.enabled_sepsis_task_id.sepsistask_7_id, this.taskSevenDataObj);
