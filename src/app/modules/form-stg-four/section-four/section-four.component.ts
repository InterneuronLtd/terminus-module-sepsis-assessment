...
@Component({
  selector: 'app-form4-section-four',
  templateUrl: './section-four.component.html',
  styleUrls: ['./section-four.component.css']
})
export class SectionFourComponent extends FormStageFourSectionBaseComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.sectionFourAssessmentDetail = super.retrieveSectionAssessmentDetail(this.actionMode,
      FORM_STG_FOUR_CONFIG.enabled_section_id.section_4_id, this.assessment.assessmentdetails);

    this.originalSectionDataObj = this.sectionDataObj = super.retrieveSectionData(this.actionMode, FORM_STG_FOUR_CONFIG.section_4_config.question_1_id, this.sectionFourAssessmentDetail);
  ...
  submitForm() {
    ...
    if (this.hasTask)
      this.assessment.taskformsectionid = FORM_STG_FOUR_CONFIG.enabled_section_id.section_4_id;
  ...
  preparePostSaveActionBasedOnStatus(status: string, showTaskAction?: boolean) {
    ...
    this.postSaveAction(this.saveStatusMessagePopup, FORM_STG_FOUR_CONFIG.section_4_config.messages.SuccessSaveMessage,
      FORM_STG_FOUR_CONFIG.section_4_config.messages.ErrorSaveMessage,
      () => {
