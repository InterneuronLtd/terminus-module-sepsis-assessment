...
export class SectionFourVM {
    ...
    questionid: string = FORM_STG_FOUR_CONFIG.section_4_config.question_1_id;//FORM_ONE_CONFIG.section_4_config.question_1_id;//"d4fa85d3-e968-4e64-b76f-f97a8e549c2c"
