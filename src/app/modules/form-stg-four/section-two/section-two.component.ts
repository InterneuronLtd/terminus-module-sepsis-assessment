...
@Component({
  selector: 'app-form4-section-two',
  templateUrl: './section-two.component.html',
  styleUrls: ['./section-two.component.css']
})
export class SectionTwoComponent extends FormStageFourSectionBaseComponent implements OnInit, OnDestroy {
  readOnly = false;
  _actionMode: string;
  ...
  constructor(protected injector: Injector,
    ...
    this.saveConfirmation(this.confirmationMessagePopup, FORM_STG_FOUR_CONFIG.section_2_config.messages.SaveConfirmationMessage,
      () => {
  ...
  ngOnInit() {
    ...
    this.sectionTwoAssessmentDetail = super.retrieveSectionAssessmentDetail(this.actionMode,
      FORM_STG_FOUR_CONFIG.enabled_section_id.section_2_id, this.assessment.assessmentdetails);

    this.originalSectionDataObj = this.sectionDataObj = super.retrieveSectionData(this.actionMode, FORM_STG_FOUR_CONFIG.section_2_config.question_1_id, this.sectionTwoAssessmentDetail);
    ...
    this.formStageFourContextService.displaySectionThree = this.sectionTwoVM.selectedYesNo === 'YES'; 
  ...
  resetOtherDependentSectionsData(): any {
    ...
    let dependentAssessmentDetails: AssessmentDetail[] = this.assessment.assessmentdetails.filter(ad =>
      ad.formsection_id == FORM_STG_FOUR_CONFIG.enabled_section_id.section_4_id || ad.formsection_id == FORM_STG_FOUR_CONFIG.enabled_section_id.section_3_id);
  ...
  preparePostSaveActionBasedOnStatus(status: string, showNextAction?: boolean) {
    ...
    this.postSaveAction(this.saveStatusMessagePopup, FORM_STG_FOUR_CONFIG.section_2_config.messages.SuccessSaveMessage,
      FORM_STG_FOUR_CONFIG.section_2_config.messages.ErrorSaveMessage,
      () => {
