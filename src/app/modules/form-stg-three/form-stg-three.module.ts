...
import { FormStageThreeComponent } from './form-stg-three.component';
...
const FormStageThreeComponents = [
    FormStageThreeComponent,
    FormStageThreeSectionBaseComponent,
    FormThreeTaskBaseComponent,
    SectionOneComponent,
    SectionTwoComponent,
...
@NgModule({
    ...
    providers: [FormStageThreeContextService, 
...
export class FormStageThreeModule {
