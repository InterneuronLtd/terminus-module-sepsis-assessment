...
@Component({
  selector: 'app-form3-section-three',
  templateUrl: './section-three.component.html',
  styleUrls: ['./section-three.component.css']
})
export class SectionThreeComponent extends FormStageThreeSectionBaseComponent implements OnInit, OnDestroy {
  ...
  howConfirmationMessagePopup = false;
  ...
  ngOnInit() {
    ...
    this.sectionThreeAssessmentDetail = super.retrieveSectionAssessmentDetail(this.actionMode,
      FORM_STG_THREE_CONFIG.enabled_section_id.section_3_id, this.assessment.assessmentdetails);

    this.sectionDataObj = super.retrieveSectionData(this.actionMode, FORM_STG_THREE_CONFIG.section_3_config.question_1_id, this.sectionThreeAssessmentDetail);
    ...
    this.formStageThreeContextService.displaySectionFour = this.sectionThreeVM.selectedYesNo == 'NO';
  ...
  onDecisionChange(event: any) {
    ...
    this.formStageThreeContextService.displaySectionFour = false;

    if (this.sectionThreeVM.selectedYesNo === 'NO') {
      this.formStageThreeContextService.displaySectionFour = true;
  ...
  resetOtherDependentSectionsData(): any {
    ...
    let dependentAssessmentDetails: AssessmentDetail[] = this.assessment.assessmentdetails.filter(ad =>
      ad.formsection_id == FORM_STG_THREE_CONFIG.enabled_section_id.section_4_id);
  ...
  submitForm() {
    ...
    this.assessment.taskformsectionid = FORM_STG_THREE_CONFIG.enabled_section_id.section_3_id;
  ...
  preparePostSaveActionBasedOnStatus(status: string, showNextAction?: boolean) {
    ...
    this.postSaveAction(this.saveStatusMessagePopup, FORM_STG_THREE_CONFIG.section_3_config.messages.SuccessSaveMessage,
      FORM_STG_THREE_CONFIG.section_3_config.messages.ErrorSaveMessage,
      () => {
