...
// })
@Injectable()
export class ViewModeAssessmentModelBuilderService implements IAssessmentModelBuilderService, OnDestroy {
    ...
    onDestroy(): void {
        this.loggerService.log("destroying in ViewModeAssessmentModelBuilderService");
