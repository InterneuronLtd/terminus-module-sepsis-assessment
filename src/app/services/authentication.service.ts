...
export class AuthenticationService {
  ...
  public async requestToken() {
    ...
    await this.httpClient.post(`${SepsisAssessmentModuleConfigData.Config.identity_service.base_uri}/connect/token`, "grant_type=client_credentials&client_id=client&client_secret=secret&scope=dynamicapi.read",
      { headers: headers })
